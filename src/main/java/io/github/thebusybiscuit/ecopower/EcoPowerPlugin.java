...
public class EcoPowerPlugin extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        SteamTurbine simpleTurbine = registerSteamTurbine(itemGroup, "STEAM_TURBINE", "aefd921cb61594324f3c09d7ac7d38185d2734333968f3ac38382cddf15f6d71", "&e简易蒸汽涡轮", MachineTier.MEDIUM, 4, new ItemStack[] {
                null, rotor, null,
                SlimefunItems.STEEL_INGOT, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.STEEL_INGOT,
                null, SlimefunItems.COPPER_WIRE, null
        });
        
        SteamTurbine advancedTurbine = registerSteamTurbine(itemGroup, "STEAM_TURBINE_2", "161aad79fb748bff1e6e94d4b6a5a277cc961c1a9abfe2a4ed88baab8a2b5971", "&c进阶蒸汽涡轮", MachineTier.ADVANCED, 6, new ItemStack[] {
                null, rotor, null,
        ...
        registerSteamTurbine(itemGroup, "STEAM_TURBINE_3", "b65e29a67860d82f66afe1060ec8a9ceacc8c7afe108f5d42f52ba854b0a62dc", "&4黑金刚石蒸汽涡轮", MachineTier.END_GAME, 13, new ItemStack[] {
                null, rotor, null,
        ...
        WindTurbine simpleWindTurbine = registerWindTurbine(itemGroup, "WIND_TURBINE", "d23e4ce096e00eae6aba10d356b785c3fecc5aa3d7dad4a4a2a27ed7750df981", "&e简易风力发电机", MachineTier.MEDIUM, 5, new ItemStack[] {
                null, rotor, null,
                SlimefunItems.STEEL_THRUSTER, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.STEEL_THRUSTER,
                null, SlimefunItems.COPPER_WIRE, null
        });

        WindTurbine advancedWindTurbine = registerWindTurbine(itemGroup, "WIND_TURBINE_2", "2df9e595dbeac33f43b37dd4ffbc234ea0fa7c3f98aad77dc906ce5d6783c79d", "&c进阶风力发电机", MachineTier.ADVANCED, 11, new ItemStack[] {
                null, rotor, null,
        ...
        registerWindTurbine(itemGroup, "WIND_TURBINE_3", "3fcef461b43f06ef9d58c94065bbf41b77a10050520b44082d5f66f6dbe71da0", "&4黑金刚石风力发电机", MachineTier.END_GAME, 23, new ItemStack[] {
        ...
        registerLightningReceptor(itemGroup, "LIGHTNING_RECEPTOR", "&e闪电接收器", 512, 8192, new ItemStack[] {
        ...
        LunarGenerator lunarGenerator = registerLunarGenerator(itemGroup, "LUNAR_GENERATOR", "&5月光发电机", 128, new ItemStack[] {
        ...
        SolarGenerator solarGenerator = registerHighEnergySolarGenerator(itemGroup, "HIGH_ENERGY_SOLAR_GENERATOR", "c4fe135c311f7086edcc5e6dbc4ef4b23f819fddaa42f827dac46e3574de2287", "&9高能太阳能发电机", 256, new ItemStack[] {
        ...
        registerSolarHelmet(itemGroup, "HIGH_ENERGY_SOLAR_HELMET", "&9高能太阳能头盔", 5, new ItemStack[] {
        ...
        registerHighEnergySolarGenerator(itemGroup, "RADIANT_SOLAR_GENERATOR", "240775c3ad75763613f32f04986881bbe4eee4366d0c57f17f7c7514e2d0a77d", "&9辐射太阳能发电机", 512, new ItemStack[] {
    ...
    private WindTurbine registerWindTurbine(ItemGroup itemGroup, String id, String texture, String name, MachineTier tier, int power, ItemStack[] recipe) {
        SlimefunItemStack turbineItem = new SlimefunItemStack(id, texture, name, "", "&7用于建造完整的" + name + "");
    ...
    private SteamTurbine registerSteamTurbine(ItemGroup itemGroup, String id, String texture, String name, MachineTier tier, int power, ItemStack[] recipe) {
        SlimefunItemStack turbineItem = new SlimefunItemStack(id, texture, name, "&7用于建造完整的" + name + "发电机");
    ...
    private LightningReceptor registerLightningReceptor(ItemGroup itemGroup, String id, String name, int min, int max, ItemStack[] recipe) {
        ...
        SlimefunItemStack item = new SlimefunItemStack(id, texture, name, "", "&f该机器可以收集来自闪电的能量", "&f并转为电力", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.GENERATOR), LoreBuilder.power(min, " - " + max + " J 每次闪电命中"));
    ...
    private LunarGenerator registerLunarGenerator(ItemGroup itemGroup, String id, String name, int power, ItemStack[] recipe) {
        ...
        SlimefunItemStack item = new SlimefunItemStack(id, texture, name, "", "&d仅在夜间工作", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.GENERATOR), LoreBuilder.powerBuffer(0), LoreBuilder.powerPerSecond(power * 2));
    ...
    private HighEnergySolarGenerator registerHighEnergySolarGenerator(ItemGroup itemGroup, String id, String texture, String name, int power, ItemStack[] recipe) {
        SlimefunItemStack item = new SlimefunItemStack(id, texture, name, "", "&d全天运作", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.GENERATOR), LoreBuilder.powerBuffer(0), LoreBuilder.powerPerSecond(power * 2));
    ...
    private SolarHelmet registerSolarHelmet(ItemGroup itemGroup, String id, String name, int power, ItemStack[] recipe) {
        SlimefunItemStack item = new SlimefunItemStack(id, Material.IRON_HELMET, name, "", "&f该太阳能头盔可以给", "&f手持或穿戴物品充能", "", LoreBuilder.power(power, " 每次充电"));
    ...
    public String getBugTrackerURL() {
        return "https://github.com/ybw0014/EcoPower-CN/issues";
    }
